...
namespace virtual_pet_game
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            {
                c.SwaggerDoc("v1", new Info { Title = "Virtual Pet Game", Version = "v1" });
            });
        }
        ...
        public void Configure(IApplicationBuilder app, IHostingEnvironment env)
        {
            ...
            app.UseSwaggerUI(c =>
            {
                c.SwaggerEndpoint("/swagger/v1/swagger.json", "Virtual Pet Game");
            });
        }
        ...
        private void RegisterDIServices(IServiceCollection services)
        {
            ...
            services.AddTransient<IAnimalStateManager, AnimalStateManager>();
